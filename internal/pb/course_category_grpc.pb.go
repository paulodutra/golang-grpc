...
type CategoryServiceClient interface {
	...
	CreateCategorysStreamBidirectional(ctx context.Context, opts ...grpc.CallOption) (CategoryService_CreateCategorysStreamBidirectionalClient, error)
...
func (c *categoryServiceClient) CreateCategorysStreamBidirectional(ctx context.Context, opts ...grpc.CallOption) (CategoryService_CreateCategorysStreamBidirectionalClient, error) {
	stream, err := c.cc.NewStream(ctx, &CategoryService_ServiceDesc.Streams[1], "/pb.CategoryService/CreateCategorysStreamBidirectional", opts...)
	if err != nil {
		return nil, err
	}
	x := &categoryServiceCreateCategorysStreamBidirectionalClient{stream}
	return x, nil
}

type CategoryService_CreateCategorysStreamBidirectionalClient interface {
	Send(*CreateCategoryRequest) error
	Recv() (*Category, error)
	grpc.ClientStream
}

type categoryServiceCreateCategorysStreamBidirectionalClient struct {
	grpc.ClientStream
}

func (x *categoryServiceCreateCategorysStreamBidirectionalClient) Send(m *CreateCategoryRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *categoryServiceCreateCategorysStreamBidirectionalClient) Recv() (*Category, error) {
	m := new(Category)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type CategoryServiceServer interface {
	...
	CreateCategorysStreamBidirectional(CategoryService_CreateCategorysStreamBidirectionalServer) error
...
func (UnimplementedCategoryServiceServer) CreateCategorysStreamBidirectional(CategoryService_CreateCategorysStreamBidirectionalServer) error {
	return status.Errorf(codes.Unimplemented, "method CreateCategorysStreamBidirectional not implemented")
}
...
func _CategoryService_CreateCategorysStreamBidirectional_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(CategoryServiceServer).CreateCategorysStreamBidirectional(&categoryServiceCreateCategorysStreamBidirectionalServer{stream})
}

type CategoryService_CreateCategorysStreamBidirectionalServer interface {
	Send(*Category) error
	Recv() (*CreateCategoryRequest, error)
	grpc.ServerStream
}

type categoryServiceCreateCategorysStreamBidirectionalServer struct {
	grpc.ServerStream
}

func (x *categoryServiceCreateCategorysStreamBidirectionalServer) Send(m *Category) error {
	return x.ServerStream.SendMsg(m)
}

func (x *categoryServiceCreateCategorysStreamBidirectionalServer) Recv() (*CreateCategoryRequest, error) {
	m := new(CreateCategoryRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
var CategoryService_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "CreateCategorysStreamBidirectional",
			Handler:       _CategoryService_CreateCategorysStreamBidirectional_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
